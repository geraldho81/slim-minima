            ...
            <details className="mb-3">
              ...
              <div className="ad-field">
                ...
                <p style={{ fontSize: "12px", color: "var(--ad-muted)", marginTop: "-0.1rem", marginBottom: "0.5rem", lineHeight: 1.5 }}>
                  Schema markup is hidden code that tells Google and AI search engines what this post is (an article, recipe, review, and so on). Done well, it can earn rich results like star ratings and images in search.
                  <br />
                  Optional. Slim Minima already adds standard article schema for every post automatically, so only use this box to add extra structured data of your own. Paste a single JSON-LD object below.
                </p>
